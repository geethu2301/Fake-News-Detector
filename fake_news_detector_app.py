...
csv_url = "https://raw.githubusercontent.com/geethu2301/Fake-News-Detector/main/Fake_Real_Data.csv"
...
if option == "Train New Model":
    model, vectorizer = train_model(csv_url)
else:
